    ...
    <>
      <div className='container-fluid mb-4'>
        <div className="d-flex align-items-center justify-content-between mb-4">
          <h1 className="h3 mb-0 text-gray-800">Gestionar usuarios</h1>
        ...
        <div className='card border-left-success shadow-sm'>
          ...
          <div className='card-body'>
            <button className='btn btn-success mb-3' onClick={user_createShowHandle}><i className="fa-solid fa-plus"></i> Añadir usuario</button>
                  ...
                  dato.ID_USUARIO === '' ? '' :
                    <tr key={index}>
                      ...
                      <td className='d-flex justify-content-center align-items-center'>
                        <button className='btn btn-sm btn-primary me-2' onClick={() => { user_editShowHandle(dato) }}><i className="fa-solid fa-pencil"></i></button>
                        <button className='btn btn-sm btn-danger' onClick={() => { user_deleteShowHandle(dato) }}><i className="fa-solid fa-eraser"></i></button>
                      </td>
                    </tr>
                ))}
              </tbody>
